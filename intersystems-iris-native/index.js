...
try {
	...
	if (platname.includes('docker')) platname = platname.replace('docker', 'lnx')
...
function isRunningInDocker() {
	...
	return fs.existsSync('/.dockerenv') 
		...
		|| execSync('cat /proc/1/sgroup', {encoding:'utf8',stdio:'pipe'}).includes('/docker/')
}
